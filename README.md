...
│   ├── shell.py         # Основной класс Shell с командами
│   ├── commands.py      # Реализация команд (ls, cd, cat, etc.)
│   ├── constants.py     # Константы (например, LOG_FILE = 'shell.log')
│   └── logger.py        # Настройка логирования
├── tests/
│   └── test_commands.py # Тесты
├── shell.log            # Будет создаваться автоматически
├── README.md
└── requirements.txt
